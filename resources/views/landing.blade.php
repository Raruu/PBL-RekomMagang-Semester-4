...
<head>
  ...
  <title>Selamat Datang Di Landing Remagang</title>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            <h1>Selamat Datang di Remagang </h1>
            <p>Situs yang menyediakan Lowongan Magang</p>
            <div class="d-flex">
              <a href="{{ route('login') }}" class="btn-get-started">Login</a>

              <a href="https://youtu.be/ptBx39KeXT0?si=XfHQr150E71JxDyV" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
            </div>
          </div>
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
            <img src="/assets/img/logonya.webp" class="img-fluid animated" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <p>Platform digital yang membantu mahasiswa mendapatkan rekomendasi magang secara personal dan akurat yang didukung oleh data dan kemitraan dengan berbagai perusahaan, kami bantu kamu melangkah lebih dekat ke dunia kerja. </p>
