            ...
            <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#"
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold rounded-top mb-2">
                        ...
                        <svg class="icon me-2">
                            <use xlink:href="{{ url('build/@coreui/icons/sprites/free.svg#cil-bell') }}"></use>
                        </svg> Updates<span class="badge badge-sm bg-info ms-2">42</span></a><a class="dropdown-item"
                        href="#">
                        <svg class="icon me-2">
                            <use xlink:href="{{ url('build/@coreui/icons/sprites/free.svg#cil-envelope-open') }}">
                            </use>
                        </svg> Messages<span class="badge badge-sm bg-success ms-2">42</span></a><a
                        class="dropdown-item" href="#">
                        <svg class="icon me-2">
                            <use xlink:href="{{ url('build/@coreui/icons/sprites/free.svg#cil-task') }}"></use>
                        </svg> Tasks<span class="badge badge-sm bg-danger ms-2">42</span></a><a class="dropdown-item"
                        href="#">
                        <svg class="icon me-2">
                            <use xlink:href="{{ url('build/@coreui/icons/sprites/free.svg#cil-comment-square') }}">
                            </use>
                    ...
                    <div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold my-2">
                        ...
                        <svg class="icon me-2">
                            <use xlink:href="{{ url('build/@coreui/icons/sprites/free.svg#cil-settings') }}"></use>
                        </svg> Settings</a><a class="dropdown-item" href="#">
                        <svg class="icon me-2">
                            <use xlink:href="{{ url('build/@coreui/icons/sprites/free.svg#cil-credit-card') }}">
                            </use>
