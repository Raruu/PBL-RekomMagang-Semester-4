            ...
            <div class="d-flex flex-column text-start align-items-center card p-3" style="height: fit-content;">
                <div class="d-flex flex-row gap-3" style="min-width: 300px; max-width: 300px;">
                    <div class="position-relative"
                        ...
                        <img src="{{ $user->foto_profil ? asset('storage/foto_dosen/' . $user->foto_profil) : asset('imgs/profile_placeholder.jpg') }}?{{ now() }}"
                ...
                <a href="{{ url('/dosen/profile/edit') }}" class="btn btn-primary mt-3 w-100">
                    Edit Profil
                </a>
            </div>
        </div>
