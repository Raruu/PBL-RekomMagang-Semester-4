            ...
            <div class="card mb-3">
                ...
                <div class="card-body position-relative pt-3">
                    ...
                    <div class="position-absolute top-0 end-0 mt-2 me-2 d-flex flex-column gap-2">
                        <a href="{{ route('dosen.mahasiswabimbingan') }}" class="btn btn-lg btn-secondary">
                            <i class="fas fa-arrow-left me-1"></i> Kembali
                        </a>
                        <a href="{{ route('dosen.detail.logAktivitas', $pengajuan->pengajuan_id) }}" class="btn btn-lg btn-primary">
