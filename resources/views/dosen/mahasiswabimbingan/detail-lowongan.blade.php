<div class="d-flex flex-row w-100">
    <div class="card-body d-flex flex-column gap-2 flex-fill display-detail">
        <div class="d-flex flex-row gap-2 align-items-end justify-content-between">
            <div class="d-flex flex-row gap-2 align-items-end">
                <h3 class="fw-bold mb-0">{{ $pengajuan->lowonganMagang->judul_lowongan }} </h3>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="d-flex flex-column gap-2">
                @foreach ($tingkat_kemampuan as $keytingkatKemampuan => $tingkatKemampuan)
                    @php
                        $keahlianLowongan = $pengajuan->lowonganMagang->keahlianLowongan->where(
                            'kemampuan_minimum',
                            $keytingkatKemampuan,
                        );
                    @endphp
                ...
                <div class="d-flex flex-column gap-0 align-items-center">
                    ...
                    <div>
                        <span class="badge bg-primary my-auto">
                            {{ ucfirst($pengajuan->lowonganMagang->tipe_kerja_lowongan) }}
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex flex-column gap-1 mt-1">
            ...
            <div class="d-flex flex-row gap-1 align-content-center justify-content-start">
                ...
                <div>
                    <p class="mb-0">
                        {{ \Carbon\Carbon::parse($pengajuan->lowonganMagang->tanggal_mulai)->format('d/m/Y') }}
                    </p>
                </div>
            </div>
            <div class="d-flex flex-row gap-1 align-content-center justify-content-start">
                ...
                <div>
                    <p class="mb-0">
                        {{ \Carbon\Carbon::parse($pengajuan->lowonganMagang->tanggal_selesai)->format('d/m/Y') }}
                    </p>
                </div>
            </div>
