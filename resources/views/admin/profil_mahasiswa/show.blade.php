            ...
            <div class=" sticky-top">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingProdi"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingSemester" placeholder="Semester"
                                        value="{{ $mahasiswa->profilMahasiswa->angkatan ?? 'Tidak tersedia' }}"
                                        disabled>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Alamat" id="floatingAlamat"
                                style="height: 100px"
                        ...
                        <div class="card-body">
                            ...
                            @foreach($mahasiswa->profilMahasiswa->pengalamanMahasiswa as $pengalaman)
                                <div class="card border-left-primary mb-3" style="border-left: 4px solid #007bff;">
                                    <div class="card-body">
                                        <h6 class="font-weight-bold mb-1">{{ $pengalaman->nama_pengalaman ?? 'Pengalaman' }}
                                        </h6>
