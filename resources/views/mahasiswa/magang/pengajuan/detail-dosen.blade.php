<div class="card-body d-flex flex-column gap-2 flex-fill display-detail" style="opacity: 0">
    <div class="d-flex flex-row gap-3 flex-fill">
        <div for="profile_picture" class="position-relative"
            ...
            <img src="{{ $dosen->foto_profil == url('storage/profile_pictures/') ? asset('imgs/profile_placeholder.jpg') : asset($dosen->foto_profil) }}?{{ now() }}"
    ...
    <div class="mb-3">
        ...
        <a class="card-text mt-0" href="https://maps.google.com/?q={{ $dosen->lokasi->latitude }},{{ $dosen->lokasi->longitude }}" target="_blank">
            {{ $dosen->lokasi->alamat }}
        </a>       
    </div>
    <div class="mb-3">
