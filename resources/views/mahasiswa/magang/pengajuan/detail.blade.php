    ...
    <div class="d-flex flex-column gap-2 pb-4">
                ...
                <div class="d-flex flex-row gap-1 mt-1 justify-content-end">
                    <div style="width: fit-content;">
                        <span
                            ...
                            {{ Str::ucfirst($statusMagang === 2 && $pengajuanMagang->status == 'disetujui' ? 'Finishing' : $pengajuanMagang->status) }}
                        </span>
                    </div>
                    <div style="width: fit-content;">
                        <span
        ...
        <div class="card d-flex flex-column">
            <ul class="nav nav-tabs" id="pengajuan-tabs">
                ...
                @endif
                @if (
                    ($statusMagang == 2 && $pengajuanMagang->status != 'ditolak' && $pengajuanMagang->status != 'menunggu') ||
